...
# ---------------------------------------------------------------------------
# AIRLINE LOGO PROXY — serves real airline logos without "preview" watermark
# Uses Wikipedia's free, openly-licensed SVG/PNG airline logos via Wikimedia
# Commons, with an in-memory cache so each logo is only fetched once per
# Railway deployment session. Falls back gracefully if unavailable.
# ---------------------------------------------------------------------------
...
# In-memory logo cache: { "EK": (bytes, content_type), ... }
_logo_cache = {}

# Wikipedia Wikimedia Commons has clean, high-res airline logos under
# free/open licenses. These direct URLs are stable and publicly accessible.
AIRLINE_LOGO_URLS = {
    "EK": "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Emirates_logo.svg/320px-Emirates_logo.svg.png",
    "QR": "https://upload.wikimedia.org/wikipedia/en/thumb/3/3a/Qatar_Airways_Logo.svg/320px-Qatar_Airways_Logo.svg.png",
    "EY": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Etihad-Airways-Logo.svg/320px-Etihad-Airways-Logo.svg.png",
    "BA": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/British_Airways_Logo.svg/320px-British_Airways_Logo.svg.png",
    "LH": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Lufthansa_Logo_2018.svg/320px-Lufthansa_Logo_2018.svg.png",
    "AF": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Air_France_Logo.svg/320px-Air_France_Logo.svg.png",
    "KL": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/KLM_logo.svg/320px-KLM_logo.svg.png",
    "TK": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Turkish_Airlines_logo_2019_compact.svg/320px-Turkish_Airlines_logo_2019_compact.svg.png",
    "SQ": "https://upload.wikimedia.org/wikipedia/en/thumb/6/6b/Singapore_Airlines_Logo_2.svg/320px-Singapore_Airlines_Logo_2.svg.png",
    "QF": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Qantas_new_logo.svg/320px-Qantas_new_logo.svg.png",
    "UA": "https://upload.wikimedia.org/wikipedia/en/thumb/e/e0/United_Airlines_Logo.svg/320px-United_Airlines_Logo.svg.png",
    "AA": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/American_Airlines_logo_2013.svg/320px-American_Airlines_logo_2013.svg.png",
    "DL": "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Delta_logo.svg/320px-Delta_logo.svg.png",
    "AC": "https://upload.wikimedia.org/wikipedia/en/thumb/7/7f/Air_Canada_Logo.svg/320px-Air_Canada_Logo.svg.png",
    "SV": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Saudia_logo.svg/320px-Saudia_logo.svg.png",
    "PK": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/PIA_logo.svg/320px-PIA_logo.svg.png",
    "FZ": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Flydubai_logo.svg/320px-Flydubai_logo.svg.png",
    "G9": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Air_Arabia_Logo.svg/320px-Air_Arabia_Logo.svg.png",
    "WY": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Oman_Air_logo.svg/320px-Oman_Air_logo.svg.png",
    "MS": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Egyptair-logo.svg/320px-Egyptair-logo.svg.png",
    "ET": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Ethiopian_Airlines_Logo.svg/320px-Ethiopian_Airlines_Logo.svg.png",
    "NZ": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Air_New_Zealand_logo_2020.svg/320px-Air_New_Zealand_logo_2020.svg.png",
    "AI": "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Air_India_Logo.svg/320px-Air_India_Logo.svg.png",
}
...
def airline_logo(airline_code):
    """
    Proxy endpoint for airline logos.
    GET /api/logo/EK  → returns Emirates logo PNG
    GET /api/logo/PK  → returns PIA logo PNG
    Falls back to 404 if airline not in our curated list, so the frontend
    can show its colored-badge fallback instead.
    """
    ...
    url = AIRLINE_LOGO_URLS.get(code)
    if not url:
